...
Glyco is intended to be used on time series of glucose in units specified under [default_values.md](default_values.md).
...
* Visualization of glucose data for personal data interpretation.

**Device Limitations:**
Glyco has certain limitations that include but are not limited to the following:
