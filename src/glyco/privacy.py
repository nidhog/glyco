...
def mask_private_information(gdf: pd.DataFrame, remove_columns: List[str], replace_columns: List[str], set_start_date: str, glucose_col: str, tsp_col: str, tsp_fmt: str, replace_func: Callable = default_replace_func, noise_std: float =0.2):
    """
